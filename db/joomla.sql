DROP TABLE IF EXISTS `m0rw4_assets`;
CREATE TABLE IF NOT EXISTS `m0rw4_assets` (
...
--
-- Dumping data for table `m0rw4_assets`
--

INSERT INTO `m0rw4_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(55, 1, 113, 114, 1, 'com_zoo', 'com_zoo', '{}'),
(56, 18, 72, 73, 2, 'com_modules.module.87', 'ZOO Category', '{}'),
(57, 18, 74, 75, 2, 'com_modules.module.88', 'ZOO Comment', '{}'),
(58, 18, 76, 77, 2, 'com_modules.module.89', 'ZOO Item', '{}'),
(59, 18, 78, 79, 2, 'com_modules.module.90', 'ZOO Quick Icons', '{}'),
(60, 18, 80, 81, 2, 'com_modules.module.91', 'ZOO Tag', '{}');

-- --------------------------------------------------------

--
-- Table structure for table `m0rw4_associations`
--

DROP TABLE IF EXISTS `m0rw4_associations`;
CREATE TABLE IF NOT EXISTS `m0rw4_associations` (
...
--
-- Table structure for table `m0rw4_banners`
--

DROP TABLE IF EXISTS `m0rw4_banners`;
CREATE TABLE IF NOT EXISTS `m0rw4_banners` (
...
--
-- Table structure for table `m0rw4_banner_clients`
--

DROP TABLE IF EXISTS `m0rw4_banner_clients`;
CREATE TABLE IF NOT EXISTS `m0rw4_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `m0rw4_banner_tracks`
--

DROP TABLE IF EXISTS `m0rw4_banner_tracks`;
CREATE TABLE IF NOT EXISTS `m0rw4_banner_tracks` (
...
--
-- Table structure for table `m0rw4_categories`
--

DROP TABLE IF EXISTS `m0rw4_categories`;
CREATE TABLE IF NOT EXISTS `m0rw4_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `m0rw4_categories`
--

INSERT INTO `m0rw4_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 190, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 190, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 190, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 190, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 190, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 190, '2011-01-01 00:00:01', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `m0rw4_contact_details`
--

DROP TABLE IF EXISTS `m0rw4_contact_details`;
CREATE TABLE IF NOT EXISTS `m0rw4_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `m0rw4_content`
--

DROP TABLE IF EXISTS `m0rw4_content`;
CREATE TABLE IF NOT EXISTS `m0rw4_content` (
...
--
-- Table structure for table `m0rw4_contentitem_tag_map`
--

DROP TABLE IF EXISTS `m0rw4_contentitem_tag_map`;
CREATE TABLE IF NOT EXISTS `m0rw4_contentitem_tag_map` (
...
--
-- Table structure for table `m0rw4_content_frontpage`
--

DROP TABLE IF EXISTS `m0rw4_content_frontpage`;
CREATE TABLE IF NOT EXISTS `m0rw4_content_frontpage` (
...
--
-- Table structure for table `m0rw4_content_rating`
--

DROP TABLE IF EXISTS `m0rw4_content_rating`;
CREATE TABLE IF NOT EXISTS `m0rw4_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `m0rw4_content_types`
--

DROP TABLE IF EXISTS `m0rw4_content_types`;
CREATE TABLE IF NOT EXISTS `m0rw4_content_types` (
...
--
-- Dumping data for table `m0rw4_content_types`
--

INSERT INTO `m0rw4_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `m0rw4_core_log_searches`
--

DROP TABLE IF EXISTS `m0rw4_core_log_searches`;
CREATE TABLE IF NOT EXISTS `m0rw4_core_log_searches` (
...
--
-- Table structure for table `m0rw4_extensions`
--

DROP TABLE IF EXISTS `m0rw4_extensions`;
CREATE TABLE IF NOT EXISTS `m0rw4_extensions` (
...
--
-- Dumping data for table `m0rw4_extensions`
--

INSERT INTO `m0rw4_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"58dff878abd62ef5a607b58d5f9e88dd"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1478595812}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{"name":"plg_system_stats","type":"plugin","creationDate":"November 2013","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2016 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_STATS_XML_DESCRIPTION","group":"","filename":"stats"}', '{"mode":3,"lastrun":"","unique_id":"d95c70fa51a741c2d9bae3bc6995836f99115340","interval":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(803, 'com_zoo', 'component', 'com_zoo', '', 1, 1, 0, 0, '{"name":"com_zoo","type":"component","creationDate":"October 2016","author":"YOOtheme","copyright":"Copyright (C) YOOtheme GmbH","authorEmail":"info@yootheme.com","authorUrl":"http:\\/\\/www.yootheme.com","version":"3.3.22","description":"ZOO component for Joomla developed by YOOtheme (http:\\/\\/www.yootheme.com)","group":"","filename":"zoo"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(804, 'ZOO Category', 'module', 'mod_zoocategory', '', 0, 1, 0, 0, '{"name":"ZOO Category","type":"module","creationDate":"October 2016","author":"YOOtheme","copyright":"Copyright (C) YOOtheme GmbH","authorEmail":"info@yootheme.com","authorUrl":"http:\\/\\/www.yootheme.com","version":"3.3.22","description":"Category module for ZOO developed by YOOtheme (http:\\/\\/www.yootheme.com)","group":"","filename":"mod_zoocategory"}', '{"theme":"","application":"","depth":"0","add_count":"0","menu_item":"","moduleclass_sfx":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(805, 'ZOO Comment', 'module', 'mod_zoocomment', '', 0, 1, 0, 0, '{"name":"ZOO Comment","type":"module","creationDate":"October 2016","author":"YOOtheme","copyright":"Copyright (C) YOOtheme GmbH","authorEmail":"info@yootheme.com","authorUrl":"http:\\/\\/www.yootheme.com","version":"3.3.22","description":"Comment module for ZOO developed by YOOtheme (http:\\/\\/www.yootheme.com)","group":"","filename":"mod_zoocomment"}', '{"theme":"","application":"","subcategories":"0","count":"10","show_avatar":"1","avatar_size":"40","show_author":"1","show_meta":"1","moduleclass_sfx":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(806, 'ZOO Item', 'module', 'mod_zooitem', '', 0, 1, 0, 0, '{"name":"ZOO Item","type":"module","creationDate":"October 2016","author":"YOOtheme","copyright":"Copyright (C) YOOtheme GmbH","authorEmail":"info@yootheme.com","authorUrl":"http:\\/\\/www.yootheme.com","version":"3.3.22","description":"Item module for ZOO developed by YOOtheme (http:\\/\\/www.yootheme.com)","group":"","filename":"mod_zooitem"}', '{"theme":"","layout":"","media_position":"left","application":"","subcategories":"0","count":"4","order":"_itemname","moduleclass_sfx":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(807, 'ZOO Quick Icons', 'module', 'mod_zooquickicon', '', 1, 1, 2, 0, '{"name":"ZOO Quick Icons","type":"module","creationDate":"October 2016","author":"YOOtheme","copyright":"Copyright (C) YOOtheme GmbH","authorEmail":"info@yootheme.com","authorUrl":"http:\\/\\/www.yootheme.com","version":"3.3.22","description":"Quick Icons module for ZOO developed by YOOtheme (http:\\/\\/www.yootheme.com)","group":"","filename":"mod_zooquickicon"}', '{}', '', '', 0, '0000-00-00 00:00:00', 3, 0),
(808, 'ZOO Tag', 'module', 'mod_zootag', '', 0, 1, 0, 0, '{"name":"ZOO Tag","type":"module","creationDate":"October 2016","author":"YOOtheme","copyright":"Copyright (C) YOOtheme GmbH","authorEmail":"info@yootheme.com","authorUrl":"http:\\/\\/www.yootheme.com","version":"3.3.22","description":"Tag module for ZOO developed by YOOtheme (http:\\/\\/www.yootheme.com)","group":"","filename":"mod_zootag"}', '{"theme":"","application":"","subcategories":"0","count":"10","order":"alpha","menu_item":"","moduleclass_sfx":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(809, 'Content - ZOO Shortcode', 'plugin', 'zooshortcode', 'content', 0, 1, 1, 0, '{"name":"Content - ZOO Shortcode","type":"plugin","creationDate":"October 2016","author":"YOOtheme","copyright":"Copyright (C) YOOtheme GmbH","authorEmail":"info@yootheme.com","authorUrl":"http:\\/\\/www.yootheme.com","version":"3.3.22","description":"Shortcode plugin for ZOO developed by YOOtheme (http:\\/\\/www.yootheme.com) Usage: {zooitem OR zoocategory: ID OR alias} Optionally: {zooitem: ID text: MYTEXT}","group":"","filename":"zooshortcode"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(810, 'Smart Search - ZOO', 'plugin', 'zoosmartsearch', 'finder', 0, 1, 1, 0, '{"name":"Smart Search - ZOO","type":"plugin","creationDate":"October 2016","author":"YOOtheme","copyright":"Copyright (C) YOOtheme GmbH","authorEmail":"info@yootheme.com","authorUrl":"http:\\/\\/www.yootheme.com","version":"3.3.22","description":"Smart Search plugin for ZOO developed by YOOtheme (http:\\/\\/www.yootheme.com)","group":"","filename":"zoosmartsearch"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(811, 'Search - ZOO', 'plugin', 'zoosearch', 'search', 0, 1, 1, 0, '{"name":"Search - ZOO","type":"plugin","creationDate":"October 2016","author":"YOOtheme","copyright":"Copyright (C) YOOtheme GmbH","authorEmail":"info@yootheme.com","authorUrl":"http:\\/\\/www.yootheme.com","version":"3.3.22","description":"Search plugin for ZOO developed by YOOtheme (http:\\/\\/www.yootheme.com)","group":"","filename":"zoosearch"}', '{"search_fulltext":"0","search_limit":"50"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(812, 'System - ZOO Event', 'plugin', 'zooevent', 'system', 0, 1, 1, 0, '{"name":"System - ZOO Event","type":"plugin","creationDate":"October 2016","author":"YOOtheme","copyright":"Copyright (C) YOOtheme GmbH","authorEmail":"info@yootheme.com","authorUrl":"http:\\/\\/www.yootheme.com","version":"3.3.22","description":"Event plugin for ZOO developed by YOOtheme (http:\\/\\/www.yootheme.com)","group":"","filename":"zooevent"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(813, 'ZOO Package', 'package', 'pkg_zoo', '', 0, 1, 1, 0, '{"name":"ZOO Package","type":"package","creationDate":"October 2016","author":"YOOtheme","copyright":"Copyright (C) YOOtheme GmbH","authorEmail":"info@yootheme.com","authorUrl":"http:\\/\\/www.yootheme.com","version":"3.3.22","description":"ZOO component and extensions for Joomla developed by YOOtheme (http:\\/\\/www.yootheme.com)","group":"","filename":"pkg_zoo"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `m0rw4_finder_filters`
--

DROP TABLE IF EXISTS `m0rw4_finder_filters`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_filters` (
...
--
-- Table structure for table `m0rw4_finder_links`
--

DROP TABLE IF EXISTS `m0rw4_finder_links`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links` (
...
--
-- Table structure for table `m0rw4_finder_links_terms0`
--

DROP TABLE IF EXISTS `m0rw4_finder_links_terms0`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links_terms0` (
...
--
-- Table structure for table `m0rw4_finder_links_terms1`
--

DROP TABLE IF EXISTS `m0rw4_finder_links_terms1`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `m0rw4_finder_links_terms2`
--

DROP TABLE IF EXISTS `m0rw4_finder_links_terms2`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `m0rw4_finder_links_terms3`
--

DROP TABLE IF EXISTS `m0rw4_finder_links_terms3`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `m0rw4_finder_links_terms4`
--

DROP TABLE IF EXISTS `m0rw4_finder_links_terms4`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `m0rw4_finder_links_terms5`
--

DROP TABLE IF EXISTS `m0rw4_finder_links_terms5`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `m0rw4_finder_links_terms6`
--

DROP TABLE IF EXISTS `m0rw4_finder_links_terms6`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `m0rw4_finder_links_terms7`
--

DROP TABLE IF EXISTS `m0rw4_finder_links_terms7`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `m0rw4_finder_links_terms8`
--

DROP TABLE IF EXISTS `m0rw4_finder_links_terms8`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `m0rw4_finder_links_terms9`
--

DROP TABLE IF EXISTS `m0rw4_finder_links_terms9`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `m0rw4_finder_links_termsa`
--

DROP TABLE IF EXISTS `m0rw4_finder_links_termsa`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `m0rw4_finder_links_termsb`
--

DROP TABLE IF EXISTS `m0rw4_finder_links_termsb`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `m0rw4_finder_links_termsc`
--

DROP TABLE IF EXISTS `m0rw4_finder_links_termsc`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `m0rw4_finder_links_termsd`
--

DROP TABLE IF EXISTS `m0rw4_finder_links_termsd`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `m0rw4_finder_links_termse`
--

DROP TABLE IF EXISTS `m0rw4_finder_links_termse`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `m0rw4_finder_links_termsf`
--

DROP TABLE IF EXISTS `m0rw4_finder_links_termsf`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Table structure for table `m0rw4_finder_taxonomy`
--

DROP TABLE IF EXISTS `m0rw4_finder_taxonomy`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `m0rw4_finder_taxonomy`
--

INSERT INTO `m0rw4_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `m0rw4_finder_taxonomy_map`
--

DROP TABLE IF EXISTS `m0rw4_finder_taxonomy_map`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `m0rw4_finder_terms`
--

DROP TABLE IF EXISTS `m0rw4_finder_terms`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_terms` (
...
--
-- Table structure for table `m0rw4_finder_terms_common`
--

DROP TABLE IF EXISTS `m0rw4_finder_terms_common`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Dumping data for table `m0rw4_finder_terms_common`
--

INSERT INTO `m0rw4_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `m0rw4_finder_tokens`
--

DROP TABLE IF EXISTS `m0rw4_finder_tokens`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `m0rw4_finder_tokens_aggregate`
--

DROP TABLE IF EXISTS `m0rw4_finder_tokens_aggregate`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Table structure for table `m0rw4_finder_types`
--

DROP TABLE IF EXISTS `m0rw4_finder_types`;
CREATE TABLE IF NOT EXISTS `m0rw4_finder_types` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `m0rw4_languages`
--

DROP TABLE IF EXISTS `m0rw4_languages`;
CREATE TABLE IF NOT EXISTS `m0rw4_languages` (
...
--
-- Dumping data for table `m0rw4_languages`
--

INSERT INTO `m0rw4_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `m0rw4_menu`
--

DROP TABLE IF EXISTS `m0rw4_menu`;
CREATE TABLE IF NOT EXISTS `m0rw4_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `m0rw4_menu`
--

INSERT INTO `m0rw4_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(102, 'main', 'com_zoo', 'com-zoo', '', 'com-zoo', 'index.php?option=com_zoo', 'component', 0, 1, 1, 803, 0, '0000-00-00 00:00:00', 0, 1, 'components/com_zoo/assets/images/zoo_16.png', 0, '{}', 43, 44, 0, '', 1);

-- --------------------------------------------------------

--
-- Table structure for table `m0rw4_menu_types`
--

DROP TABLE IF EXISTS `m0rw4_menu_types`;
CREATE TABLE IF NOT EXISTS `m0rw4_menu_types` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `asset_id` int(11) NOT NULL,
...
--
-- Dumping data for table `m0rw4_menu_types`
--

INSERT INTO `m0rw4_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `m0rw4_messages`
--

DROP TABLE IF EXISTS `m0rw4_messages`;
CREATE TABLE IF NOT EXISTS `m0rw4_messages` (
...
--
-- Table structure for table `m0rw4_messages_cfg`
--

DROP TABLE IF EXISTS `m0rw4_messages_cfg`;
CREATE TABLE IF NOT EXISTS `m0rw4_messages_cfg` (
...
--
-- Table structure for table `m0rw4_modules`
--

DROP TABLE IF EXISTS `m0rw4_modules`;
CREATE TABLE IF NOT EXISTS `m0rw4_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `m0rw4_modules`
--

INSERT INTO `m0rw4_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(87, 56, 'ZOO Category', '', '', 0, '', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_zoocategory', 1, 1, '', 0, '*'),
(88, 57, 'ZOO Comment', '', '', 0, '', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_zoocomment', 1, 1, '', 0, '*'),
(89, 58, 'ZOO Item', '', '', 0, '', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_zooitem', 1, 1, '', 0, '*'),
(90, 59, 'ZOO Quick Icons', '', '', 2, 'icon', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_zooquickicon', 1, 1, '', 1, '*'),
(91, 60, 'ZOO Tag', '', '', 0, '', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 'mod_zootag', 1, 1, '', 0, '*');

-- --------------------------------------------------------

--
-- Table structure for table `m0rw4_modules_menu`
--

DROP TABLE IF EXISTS `m0rw4_modules_menu`;
CREATE TABLE IF NOT EXISTS `m0rw4_modules_menu` (
...
--
-- Dumping data for table `m0rw4_modules_menu`
--

INSERT INTO `m0rw4_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `m0rw4_newsfeeds`
--

DROP TABLE IF EXISTS `m0rw4_newsfeeds`;
CREATE TABLE IF NOT EXISTS `m0rw4_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `m0rw4_overrider`
--

DROP TABLE IF EXISTS `m0rw4_overrider`;
CREATE TABLE IF NOT EXISTS `m0rw4_overrider` (
...
--
-- Table structure for table `m0rw4_postinstall_messages`
--

DROP TABLE IF EXISTS `m0rw4_postinstall_messages`;
CREATE TABLE IF NOT EXISTS `m0rw4_postinstall_messages` (
...
--
-- Dumping data for table `m0rw4_postinstall_messages`
--

INSERT INTO `m0rw4_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `m0rw4_redirect_links`
--

DROP TABLE IF EXISTS `m0rw4_redirect_links`;
CREATE TABLE IF NOT EXISTS `m0rw4_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `m0rw4_schemas`
--

DROP TABLE IF EXISTS `m0rw4_schemas`;
CREATE TABLE IF NOT EXISTS `m0rw4_schemas` (
...
--
-- Dumping data for table `m0rw4_schemas`
--

INSERT INTO `m0rw4_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.6.3-2016-08-16');

-- --------------------------------------------------------

--
-- Table structure for table `m0rw4_session`
--

DROP TABLE IF EXISTS `m0rw4_session`;
CREATE TABLE IF NOT EXISTS `m0rw4_session` (
...
--
-- Dumping data for table `m0rw4_session`
--

INSERT INTO `m0rw4_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('70ofagvtodii2c52i04c3rqjr0', 0, 1, '1478604903', 'joomla|s:716:"";', 0, ''),
('mvtas6jmt1r19r5ifou0923nb1', 1, 1, '1478604915', 'joomla|s:712:"";', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `m0rw4_tags`
--

DROP TABLE IF EXISTS `m0rw4_tags`;
CREATE TABLE IF NOT EXISTS `m0rw4_tags` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `m0rw4_tags`
--

INSERT INTO `m0rw4_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 190, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `m0rw4_template_styles`
--

DROP TABLE IF EXISTS `m0rw4_template_styles`;
CREATE TABLE IF NOT EXISTS `m0rw4_template_styles` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `m0rw4_template_styles`
--

INSERT INTO `m0rw4_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `m0rw4_ucm_base`
--

DROP TABLE IF EXISTS `m0rw4_ucm_base`;
CREATE TABLE IF NOT EXISTS `m0rw4_ucm_base` (
...
--
-- Table structure for table `m0rw4_ucm_content`
--

DROP TABLE IF EXISTS `m0rw4_ucm_content`;
CREATE TABLE IF NOT EXISTS `m0rw4_ucm_content` (
...
--
-- Table structure for table `m0rw4_ucm_history`
--

DROP TABLE IF EXISTS `m0rw4_ucm_history`;
CREATE TABLE IF NOT EXISTS `m0rw4_ucm_history` (
...
--
-- Table structure for table `m0rw4_updates`
--

DROP TABLE IF EXISTS `m0rw4_updates`;
CREATE TABLE IF NOT EXISTS `m0rw4_updates` (
...
--
-- Table structure for table `m0rw4_update_sites`
--

DROP TABLE IF EXISTS `m0rw4_update_sites`;
CREATE TABLE IF NOT EXISTS `m0rw4_update_sites` (
...
--
-- Dumping data for table `m0rw4_update_sites`
--

INSERT INTO `m0rw4_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1478595840, ''),
(2, 'Joomla! Extension Directory', 'collection', 'https://update.joomla.org/jed/list.xml', 1, 1478595841, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 0, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1478595956, ''),
(5, 'ZOO', 'extension', 'http://yootheme.com/api/update/zoo_j33.xml', 1, 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `m0rw4_update_sites_extensions`
--

DROP TABLE IF EXISTS `m0rw4_update_sites_extensions`;
CREATE TABLE IF NOT EXISTS `m0rw4_update_sites_extensions` (
...
--
-- Dumping data for table `m0rw4_update_sites_extensions`
--

INSERT INTO `m0rw4_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 802),
(4, 28),
...
--
-- Table structure for table `m0rw4_usergroups`
--

DROP TABLE IF EXISTS `m0rw4_usergroups`;
CREATE TABLE IF NOT EXISTS `m0rw4_usergroups` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Dumping data for table `m0rw4_usergroups`
--

INSERT INTO `m0rw4_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `m0rw4_users`
--

DROP TABLE IF EXISTS `m0rw4_users`;
CREATE TABLE IF NOT EXISTS `m0rw4_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `m0rw4_users`
--

INSERT INTO `m0rw4_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(190, 'Super User', 'admin', 'deavenor.encarna@gmail.com', '$2y$10$K1QTyS8aMYMKDiXZh6K0tuqMCKE8/L/E5kfttFZpmBMx9oX5WZxTO', 0, 1, '2016-10-20 08:37:31', '2016-11-08 09:03:58', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `m0rw4_user_keys`
--

DROP TABLE IF EXISTS `m0rw4_user_keys`;
CREATE TABLE IF NOT EXISTS `m0rw4_user_keys` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `m0rw4_user_notes`
--

DROP TABLE IF EXISTS `m0rw4_user_notes`;
CREATE TABLE IF NOT EXISTS `m0rw4_user_notes` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Table structure for table `m0rw4_user_profiles`
--

DROP TABLE IF EXISTS `m0rw4_user_profiles`;
CREATE TABLE IF NOT EXISTS `m0rw4_user_profiles` (
...
--
-- Table structure for table `m0rw4_user_usergroup_map`
--

DROP TABLE IF EXISTS `m0rw4_user_usergroup_map`;
CREATE TABLE IF NOT EXISTS `m0rw4_user_usergroup_map` (
...
--
-- Dumping data for table `m0rw4_user_usergroup_map`
--

INSERT INTO `m0rw4_user_usergroup_map` (`user_id`, `group_id`) VALUES
(190, 8);

-- --------------------------------------------------------

--
-- Table structure for table `m0rw4_utf8_conversion`
--

DROP TABLE IF EXISTS `m0rw4_utf8_conversion`;
CREATE TABLE IF NOT EXISTS `m0rw4_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `m0rw4_utf8_conversion`
--

INSERT INTO `m0rw4_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Table structure for table `m0rw4_viewlevels`
--

DROP TABLE IF EXISTS `m0rw4_viewlevels`;
CREATE TABLE IF NOT EXISTS `m0rw4_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Dumping data for table `m0rw4_viewlevels`
--

INSERT INTO `m0rw4_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `m0rw4_zoo_application`
--

DROP TABLE IF EXISTS `m0rw4_zoo_application`;
CREATE TABLE IF NOT EXISTS `m0rw4_zoo_application` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Table structure for table `m0rw4_zoo_category`
--

DROP TABLE IF EXISTS `m0rw4_zoo_category`;
CREATE TABLE IF NOT EXISTS `m0rw4_zoo_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `m0rw4_zoo_category_item`
--

DROP TABLE IF EXISTS `m0rw4_zoo_category_item`;
CREATE TABLE IF NOT EXISTS `m0rw4_zoo_category_item` (
...
--
-- Table structure for table `m0rw4_zoo_comment`
--

DROP TABLE IF EXISTS `m0rw4_zoo_comment`;
CREATE TABLE IF NOT EXISTS `m0rw4_zoo_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `m0rw4_zoo_item`
--

DROP TABLE IF EXISTS `m0rw4_zoo_item`;
CREATE TABLE IF NOT EXISTS `m0rw4_zoo_item` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `application_id` int(11) NOT NULL,
...
--
-- Table structure for table `m0rw4_zoo_rating`
--

DROP TABLE IF EXISTS `m0rw4_zoo_rating`;
CREATE TABLE IF NOT EXISTS `m0rw4_zoo_rating` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `m0rw4_zoo_search_index`
--

DROP TABLE IF EXISTS `m0rw4_zoo_search_index`;
CREATE TABLE IF NOT EXISTS `m0rw4_zoo_search_index` (
  `item_id` int(11) NOT NULL,
...
--
-- Table structure for table `m0rw4_zoo_submission`
--

DROP TABLE IF EXISTS `m0rw4_zoo_submission`;
CREATE TABLE IF NOT EXISTS `m0rw4_zoo_submission` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `application_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `alias` varchar(255) NOT NULL,
...
--
-- Table structure for table `m0rw4_zoo_tag`
--

DROP TABLE IF EXISTS `m0rw4_zoo_tag`;
CREATE TABLE IF NOT EXISTS `m0rw4_zoo_tag` (
  `item_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Table structure for table `m0rw4_zoo_version`
--

DROP TABLE IF EXISTS `m0rw4_zoo_version`;
CREATE TABLE IF NOT EXISTS `m0rw4_zoo_version` (
  `version` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `m0rw4_zoo_version`
--

INSERT INTO `m0rw4_zoo_version` (`version`) VALUES
('3.3.22');
...
--
-- Indexes for table `m0rw4_zoo_item`
--
ALTER TABLE `m0rw4_zoo_item` ADD FULLTEXT KEY `SEARCH_FULLTEXT` (`name`);

--
-- Indexes for table `m0rw4_zoo_search_index`
--
ALTER TABLE `m0rw4_zoo_search_index` ADD FULLTEXT KEY `SEARCH_FULLTEXT` (`value`);
